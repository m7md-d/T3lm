...
export function RegionPage() {
  ...
  const nextLabel = onFloor
    ...
    : region.shots[at + 1]
      ...
      : region.exercise ? 'التمرين' : undefined;
  ...
  return (
    <>
      ...
      <main className="wrap region" id="main">
        ...
        {shot && !onFloor && <Shot shot={shot} region={region.num} count={last} />}
      ...
      <Rail region={region} at={at} nextLabel={nextLabel} onPrev={onPrev} onNext={onNext} go={go} />
    </>
  );
}
