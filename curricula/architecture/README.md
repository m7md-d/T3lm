...
| [`representation`](representation) | تصميم التمثيل قبل الصيغة: الحالة الصالحة، والقواعد، والمنفذ نوعاً، والقيد، والعقد الذي يُنشَر — بالمكتبة القياسية وحدها | [زُر ↗](https://representation.nodeksa.com) | `default` | 🔨 |
<!-- doctor:list:end -->
