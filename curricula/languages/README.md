...
| [`dart`](dart) | تفكيك Dart من نظام أنواعها إلى حلقة أحداثها وisolatها — لمن أنهى C ولم يفتح Dart | `dart.nodeksa.com` | `default` | 🔨 |
| [`go`](go) | تفكيك Go من نظام أنواعها إلى تمثيلها في الذاكرة — لمن يعرف C | [زُر ↗](https://go.nodeksa.com) | `default` | 🔨 |
| [`python`](python) | تفكيك نموذج الكائنات والمفسّر والمصفوفة والحدّ مع C — لمن C مرساتُه وكتب سكربتات صغيرة | `python.nodeksa.com` | `default` | 🔨 |
